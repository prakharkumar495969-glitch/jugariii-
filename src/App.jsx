...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
          <div className="bg-white max-w-4xl w-full max-h-[95vh] rounded-xl overflow-y-auto shadow-2xl">
            <div className="p-6">
              <div className="flex justify-end sticky top-0 bg-white pb-2 z-30"> 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    {selected.gallery.map((imgUrl, index) => (
                        <img
                            ...
                            src={imgUrl}
                            className={`min-w-[64px] h-16 object-cover rounded-md cursor-pointer border-2 transition-all ${modalImage === imgUrl ? 'border-pink-600' : 'border-slate-200 hover:border-pink-300'}`}
                ...
                <div className="md:border-l md:pl-6 pt-4 md:pt-0">
                        ...
                        <ul className="list-disc list-inside text-sm text-slate-600 space-y-1">
                            ...
                            <li>Best for: 
                                <i className="font-normal">
                                    {selected.title.includes('Couple') && ' Date Nights, Anniversaries'}
                                    {selected.title.includes('Friends') && ' Parties, Get-togethers'}
                                    {selected.title.includes('Office') && ' Office Parties, Team Building'}
                                </i>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-4">
                        ...
                        <button onClick={() => setSelected(null)} className="px-6 py-3 border border-slate-500 rounded-lg hover:bg-slate-100 transition">Continue Shopping</button>
                    </div>
                </div>
      ...
      <footer className="mt-12 py-6 text-center text-sm text-slate-500 border-t">
          JUGARIII - Demo Store | Frontend Starter only
      </footer>
    </div>
  );
}
